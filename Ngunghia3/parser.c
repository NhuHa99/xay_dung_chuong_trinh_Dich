...
void eat(TokenType tokenType) //duyệt kí hiệu kết thúc 
{
...
void compileProgram(void)// duyệt kí hiệu không kết thúc 
{
    Object *program;
...
void compileParam(void)
{
    ...
    //type = compileType();  /* dung dong nay thay dong tren neu muon compile kieu tu khai bao */
...
int compile(char *fileName) //kích hoạt parser 
{
